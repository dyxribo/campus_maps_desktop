    ...
    public class Polygon {
        ...
        public function contains_point(point:Point):Boolean {
            ...
            for (var i:uint = 0; i < sides.length; i++) {
                ...
                const intersect:Boolean = ((point_a._y > point._y) !== (point_b._y > point._y)) && (point.x < (point_b.x - point_a.x) * (point._y - point_a._y) / (point_b._y - point_a._y) + point_a.x);
        ...
        public function get is_closed():Boolean {
            ...
            for (var i:uint = 0; i < this._sides.length - 1; i++) {
                if (this._sides[i].end.x !== this._sides[i + 1].begin.x || this._sides[i].end._y !== this._sides[i + 1].begin._y) {
                    return false;
                }
            }
            ...
            return first_side.begin.x === last_side.end.x && first_side.begin._y === last_side.end._y;
        }
